...
from mds.mdscuda.utils import bits, np_type, idx, euclidean_pairs_gpu

"""
Light adaptation of git repository https://github.com/SethEBaldwin/mdscuda.git, accessed 2025-07-16.
"""
...
def mds_fit(
    ...
    for k in range(n_init):
        ...
        x, sig, iter, sigmas = smacof(x, delta, max_iter, verbosity)
